...
يحتوي الخادم على مراقب دوري يقيس حجم قاعدة البيانات الحالية باستخدام PostgreSQL، ثم يقارنه بالسعة التخزينية المخصصة للخدمة. عند بلوغ الاستخدام **70%**، يُرسل تنبيهًا فوريًا واضحًا إلى لوحة التحكم عبر قناة الإشعارات الداخلية. يُرسل التنبيه مرة واحدة عند عبور الحد، ولا يتكرر في كل فحص؛ ويُعاد تفعيل التنبيه تلقائيًا إذا انخفض الاستخدام إلى ما دون الحد ثم تجاوزه مرة أخرى.
