...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[var(--z-dropdown)] min-w-[8rem] overflow-hidden rounded-[var(--radius-md)] border p-1 animate-fade-in",
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[var(--z-dropdown)] min-w-[10rem] overflow-hidden rounded-[var(--radius-md)] border p-1 animate-fade-in",
        "bg-[var(--bg-elevated)] border-[var(--border-strong)] shadow-[var(--shadow-lg)]",
        className
      )}
      {...props}
